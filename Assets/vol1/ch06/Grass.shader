    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void geom(triangle v2g i[3], inout TriangleStream<g2f> stream)
            {
                ...
                o[2].pos += dir * (_WindPower * wind * _BottomBend) * sin(_Time.y);
                o[3].pos += dir * (_WindPower * wind * _BottomBend) * sin(_Time.y);
                o[4].pos += dir * (_WindPower * wind * _MiddleBend) * sin(_Time.y);
                o[5].pos += dir * (_WindPower * wind * _MiddleBend) * sin(_Time.y);
                o[6].pos += dir * (_WindPower * wind * _TopBend) * sin(_Time.y);
